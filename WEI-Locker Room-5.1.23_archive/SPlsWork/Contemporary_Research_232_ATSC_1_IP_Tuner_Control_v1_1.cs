...
namespace UserModule_CONTEMPORARY_RESEARCH_232_ATSC_1_IP_TUNER_CONTROL_V1_1
{
    public class UserModuleClass_CONTEMPORARY_RESEARCH_232_ATSC_1_IP_TUNER_CONTROL_V1_1 : SplusObject
    {
    ...
    try
    {
        ...
        if ( Functions.TestForTrue  ( ( Functions.BoolToInt (IFLAG1 == 0))  ) ) 
            ...
            if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( ISEPARATOR > 0 ))  ) ) 
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( Functions.Atoi( SK_CHANNEL ) > 9999 ))  ) ) 
                    {
                    __context__.SourceCodeLine = 128;
                    IINVALID = (ushort) ( 1 ) ; 
                    }
...
public UserModuleClass_CONTEMPORARY_RESEARCH_232_ATSC_1_IP_TUNER_CONTROL_V1_1 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
